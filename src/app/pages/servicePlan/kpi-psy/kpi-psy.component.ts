...
import { KpiSheetService } from '../../../shared/kpi-sheet.service';
import * as Highcharts from "highcharts";
import { HttpClient } from "@angular/common/http";
@Component({
  selector: 'app-kpi-psy',
  templateUrl: './kpi-psy.component.html',
  styleUrls: ['./kpi-psy.component.scss']
})
export class KpiPsyComponent implements OnInit {
  psyApi = "https://script.google.com/macros/s/AKfycbxJnR7Y855klJEaLxrTPe6a5usv3V_gLSliCw_0Inodo-IOWA/exec";
  dataPsy: any = [];
  ...
  async ngOnInit() {
    ...
    this.chartOptions = {
      title: {
        text: "ร้อยละของผู้ป่วยโรคจิตเภทเข้าถึงบริการ ปี งบประมาณ2563",
      },credits: {
        enabled: false
      },
      xAxis: {
